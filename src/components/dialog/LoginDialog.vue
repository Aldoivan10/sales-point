...
const requiredRules: ValidationRule[] = [(val) => Boolean(val) || 'El campo no puede estar vacío']
    ...
    <q-dialog ref="dialogRef" @hide="onDialogHide">
        <q-card class="q-dialog-plugin">
                ...
                >
                    ...
                    >
                        ...
                        <template v-slot:append>
                            <q-icon
                                :name="showPass ? 'r_visibility' : 'r_visibility_off'"
            ...
            <q-card-actions align="right">
                <q-btn @click="onDialogCancel" color="negative" flat>CANCELAR</q-btn>
                <q-btn form="formLogin" type="submit" color="primary" unelevated>ACEPTAR</q-btn>
            </q-card-actions>
        </q-card>
    </q-dialog>
</template>
